(define (problem grid_9room3_fpl_s3_seed22022_n0)
  (:domain grid)
  (:objects
  ...
  (:init
    ...
    (conn p89 p79)
    ; Lock and key shapes
    (lock-shape p16 shape0)
    (lock-shape p34 shape1)
    (lock-shape p60 shape1)
    (lock-shape p83 shape1)
    (lock-shape p3 shape1)
    (lock-shape p30 shape2)
    (lock-shape p47 shape1)
    (lock-shape p29 shape1)
    (lock-shape p67 shape2)
