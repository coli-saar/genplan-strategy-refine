(define (problem grid_9room2_fpl_s3_seed16266_n0)
  (:domain grid)
  (:objects
  ...
  (:init
    ...
    (lock-shape p27 shape1)
    (lock-shape p2 shape1)
    (lock-shape p11 shape1)
    (lock-shape p18 shape1)
    (lock-shape p14 shape0)
    (lock-shape p35 shape2)
    (lock-shape p15 shape1)
